...
Les `@font-face` sont en tête de `moteur/style.css`, qui est ici un fichier
écrit à la main — contrairement au dépôt `retraitecomptenotionelle`, d'où cette
feuille est reprise et où elle est extraite d'un module Python. Une correction
faite là-bas se recopie ici ; une correction faite ici ne remonte pas toute
seule.
